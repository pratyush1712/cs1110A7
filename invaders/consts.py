...
GAME_HEIGHT = root.winfo_screenheight() - 56
...
SHIP_LIVES    = 3
# image used to animate ship blowing
SHIP_BLOW_UP = 'ship-strip.png'
# speed of animation
DEATH_SPEED = 0.5
# The y-coordinate of the defensive line the ship is protecting
DEFENSE_LINE = 100
# number of player's score to decrease if they lose a life
SHIP_BURSTS = 60
