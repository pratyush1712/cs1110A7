...
class Invaders(GameApp):
    ...
    #Attribute lastkeys: the keys that were last pressed by the user
    ...
    def start(self):
        ...
        if (self._state == STATE_INACTIVE):
            self._text = self._text = GLabel(text = "Press 'S' to play", font_size = 60, left = 5, bottom = 5, x = GAME_WIDTH/2, y = GAME_HEIGHT/2)
        else:
            self._text = None
